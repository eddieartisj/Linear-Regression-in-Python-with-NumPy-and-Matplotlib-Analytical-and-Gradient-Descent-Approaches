...
A complete implementation of simple linear regression using both the analytical (closed-form) method and gradient descent, built as part of Purdue University’s Machine Learning Foundations course. Includes gradient descent visualization, learning-rate comparison, and fully annotated Python code.

## 🎯 Purpose

This project was completed as part of the Machine Learning Foundations course in Purdue University’s Cybersecurity Workforce Certification Training Program.
...
## 📁 Project Structure
├──  Machine_Learning_Foundations_Lab_3_(Final).ipynb     # Final annotated notebook

├──  README.md                        # Project documentation

└──  figures/                         # (Optional) Saved plots and outputs
...
Tracked parameter updates (θ₀ and θ₁)
